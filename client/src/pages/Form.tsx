      ...
      <FormikProvider value={formik}>
        <Grid item xs={12} md={9}>
            ...
            <Box my={2} width="100%">
              <Paper elevation={3}>
                <Box px={3} py={2}>
                  ...
                  <Input fullWidth onChange={formik.handleChange("title")} />
                </Box>
              </Paper>
            </Box>
            <Box my={2} width="100%">
          ...
          <FieldArray
            ...
            render={(arrayHelpers) => (
              <Container fixed>
                {formik.values.fields && formik.values.fields.length > 0 ? (
                        ...
                        <Box px={3} py={2}>
                          <FormControl fullWidth>
                            ...
                            <Input
                              ...
                              fullWidth
                              value={formik.values.fields[index]?.fieldName}
                            ...
                            <Box>
                              <FormGroup>
                                <FormControlLabel
                                  ...
                                  checked={
                                    formik.values.fields[index]?.required
                                  }
              ...
              <Box mt={2} width="100%">
                ...
                <FieldArray
                  ...
                  render={(arrayHelpers) => {
                    return (
                      <>
                        {formik.values.visibility.length > 0 &&
                          formik.values.visibility.map((visibility, index) => (
                            <Chip
                              label={Object.entries(visibility)
                                .map(([key, value]) => {
                                  if (!!value) {
                                    if (key === "year_id") {
                ...
                <Button endIcon={<Add />} onClick={() => setModalOpen(true)}>
                  Add
                </Button>
              </Box>
            </Box>
